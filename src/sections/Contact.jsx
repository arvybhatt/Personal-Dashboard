...
const Contact = () => {
  return (
    <SectionContainer id="contact" title="Get In Touch" className="bg-gray-50 dark:bg-gray-900">
          ...
          <div className="dashboard-card">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400">
                  <FiMail size={18} />
                </div>
                <div className="ml-4">
                  <h4 className="text-sm font-medium text-gray-900 dark:text-white">Email</h4>
                  <p className="text-gray-600 dark:text-gray-400">
                    <a href="mailto:email@example.com" className="hover:text-blue-600 dark:hover:text-blue-400">email@example.com</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    ...
                    >
                      linkedin.com/in/arvind-bhatt-5b7537129
                    </a>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-blue-900 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                >
